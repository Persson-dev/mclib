...
public:
    ...
    virtual s32 GetPacketId(packets::out::PlayerPacket) override { return 0x0D; }
    virtual s32 GetPacketId(packets::out::PlayerPositionPacket) override { return 0x0E; }
    virtual s32 GetPacketId(packets::out::PlayerPositionAndLookPacket) override { return 0x0F; }
    virtual s32 GetPacketId(packets::out::PlayerLookPacket) override { return 0x10; }
    ...
    virtual s32 GetPacketId(packets::out::AdvancementTabPacket) override { return 0x19; }
    virtual s32 GetPacketId(packets::out::HeldItemChangePacket) override { return 0x1A; }
    virtual s32 GetPacketId(packets::out::CreativeInventoryActionPacket) override { return 0x1B; }
    virtual s32 GetPacketId(packets::out::UpdateSignPacket) override { return 0x1C; }
    virtual s32 GetPacketId(packets::out::AnimationPacket) override { return 0x1D; }
    virtual s32 GetPacketId(packets::out::SpectatePacket) override { return 0x1E; }
    virtual s32 GetPacketId(packets::out::PlayerBlockPlacementPacket) override { return 0x1F; }
    virtual s32 GetPacketId(packets::out::UseItemPacket) override { return 0x20; }
};
...
public:
    ...
    // Play
    virtual s32 GetPacketId(packets::out::TeleportConfirmPacket) override { return 0x00; }
    virtual s32 GetPacketId(packets::out::TabCompletePacket) override { return 0x01; }
    virtual s32 GetPacketId(packets::out::ChatPacket) override { return 0x02; }
    virtual s32 GetPacketId(packets::out::ClientStatusPacket) override { return 0x03; }
    virtual s32 GetPacketId(packets::out::ClientSettingsPacket) override { return 0x04; }
    virtual s32 GetPacketId(packets::out::ConfirmTransactionPacket) override { return 0x05; }
    virtual s32 GetPacketId(packets::out::EnchantItemPacket) override { return 0x06; }
    virtual s32 GetPacketId(packets::out::ClickWindowPacket) override { return 0x07; }
    virtual s32 GetPacketId(packets::out::CloseWindowPacket) override { return 0x08; }
    virtual s32 GetPacketId(packets::out::PluginMessagePacket) override { return 0x09; }
    virtual s32 GetPacketId(packets::out::UseEntityPacket) override { return 0x0A; }
    virtual s32 GetPacketId(packets::out::KeepAlivePacket) override { return 0x0B; }
    virtual s32 GetPacketId(packets::out::PlayerPacket) override { return 0x0C; }
    ...
    virtual s32 GetPacketId(packets::out::VehicleMovePacket) override { return 0x10; }
    virtual s32 GetPacketId(packets::out::SteerBoatPacket) override { return 0x11; }
    virtual s32 GetPacketId(packets::out::CraftRecipeRequestPacket) override { return 0x12; }
    virtual s32 GetPacketId(packets::out::PlayerAbilitiesPacket) override { return 0x13; }
    virtual s32 GetPacketId(packets::out::PlayerDiggingPacket) override { return 0x14; }
    virtual s32 GetPacketId(packets::out::EntityActionPacket) override { return 0x15; }
    virtual s32 GetPacketId(packets::out::SteerVehiclePacket) override { return 0x16; }
    ...
    virtual s32 GetPacketId(packets::out::PrepareCraftingGridPacket) override { throw UnsupportedPacketException("PrepareCraftingGridPacket does not work with protocol 1.12.1"); }
};
...
public:
    ...
    virtual s32 GetPacketId(packets::out::ClientStatusPacket) override { return 0x03; }
    virtual s32 GetPacketId(packets::out::ClientSettingsPacket) override { return 0x04; }
    virtual s32 GetPacketId(packets::out::TabCompletePacket) override { return 0x05; }
    virtual s32 GetPacketId(packets::out::ConfirmTransactionPacket) override { return 0x06; }
    virtual s32 GetPacketId(packets::out::EnchantItemPacket) override { return 0x07; }
    virtual s32 GetPacketId(packets::out::ClickWindowPacket) override { return 0x08; }
    virtual s32 GetPacketId(packets::out::CloseWindowPacket) override { return 0x09; }
    ...
    // EditBook = 0x0B
    // QueryEntityNBT = 0x0C
    virtual s32 GetPacketId(packets::out::UseEntityPacket) override { return 0x0D; }
    virtual s32 GetPacketId(packets::out::KeepAlivePacket) override { return 0x0E; }
    virtual s32 GetPacketId(packets::out::PlayerPacket) override { return 0x0F; }
    virtual s32 GetPacketId(packets::out::PlayerPositionPacket) override { return 0x10; }
    virtual s32 GetPacketId(packets::out::PlayerPositionAndLookPacket) override { return 0x11; }
    virtual s32 GetPacketId(packets::out::PlayerLookPacket) override { return 0x12; }
    virtual s32 GetPacketId(packets::out::VehicleMovePacket) override { return 0x13; }
    virtual s32 GetPacketId(packets::out::SteerBoatPacket) override { return 0x14; }
    // PickItem = 0x15
    virtual s32 GetPacketId(packets::out::CraftRecipeRequestPacket) override { return 0x16; }
    virtual s32 GetPacketId(packets::out::PlayerAbilitiesPacket) override { return 0x17; }
    virtual s32 GetPacketId(packets::out::PlayerDiggingPacket) override { return 0x18; }
    virtual s32 GetPacketId(packets::out::EntityActionPacket) override { return 0x19; }
    virtual s32 GetPacketId(packets::out::SteerVehiclePacket) override { return 0x1A; }
    virtual s32 GetPacketId(packets::out::CraftingBookDataPacket) override { return 0x1B; }
    // NameItem = 0x1C
    virtual s32 GetPacketId(packets::out::ResourcePackStatusPacket) override { return 0x1D; }
    virtual s32 GetPacketId(packets::out::AdvancementTabPacket) override { return 0x1E; }
    // SelectTrade = 0x1F
    // SetBeaconEffect = 0x20
    virtual s32 GetPacketId(packets::out::HeldItemChangePacket) override { return 0x21; }
    // UpdateCommandBlock = 0x22
    // UpdateCommandBlockMinecart = 0x23
    virtual s32 GetPacketId(packets::out::CreativeInventoryActionPacket) override { return 0x24; }
    // UpdateStructure = 0x25
    virtual s32 GetPacketId(packets::out::UpdateSignPacket) override { return 0x26; }
    virtual s32 GetPacketId(packets::out::AnimationPacket) override { return 0x27; }
    virtual s32 GetPacketId(packets::out::SpectatePacket) override { return 0x28; }
    virtual s32 GetPacketId(packets::out::PlayerBlockPlacementPacket) override { return 0x29; }
    virtual s32 GetPacketId(packets::out::UseItemPacket) override { return 0x2A; }
...
public:
  ...
  virtual s32 GetPacketId(packets::out::PrepareCraftingGridPacket) override { throw UnsupportedPacketException("PrepareCraftingGridPacket does not work with protocol 1.15.2"); }
};

class Protocol_1_16_5 : public Protocol {
public:
  Protocol_1_16_5(Version version, StateMap inbound)
    : Protocol(version, inbound)
  {
  ...
  // EditBook = 0x0C
  // QueryEntityNBT = 0x0D
  // Generate Structure = 0x0F
  virtual s32 GetPacketId(packets::out::UseEntityPacket) override { return 0x0E; }
  virtual s32 GetPacketId(packets::out::KeepAlivePacket) override { return 0x10; }
  // LockDifficulty = 0x11
  virtual s32 GetPacketId(packets::out::PlayerPositionPacket) override { return 0x12; }
  virtual s32 GetPacketId(packets::out::PlayerPositionAndLookPacket) override { return 0x13; }
  virtual s32 GetPacketId(packets::out::PlayerLookPacket) override { return 0x14; }
  virtual s32 GetPacketId(packets::out::PlayerPacket) override { return 0x15; }
  virtual s32 GetPacketId(packets::out::VehicleMovePacket) override { return 0x16; }
  virtual s32 GetPacketId(packets::out::SteerBoatPacket) override { return 0x17; }
  // PickItem = 0x18
  virtual s32 GetPacketId(packets::out::CraftRecipeRequestPacket) override { return 0x19; }
  virtual s32 GetPacketId(packets::out::PlayerAbilitiesPacket) override { return 0x1A; }
  virtual s32 GetPacketId(packets::out::PlayerDiggingPacket) override { return 0x1B; }
  virtual s32 GetPacketId(packets::out::EntityActionPacket) override { return 0x1C; }
  virtual s32 GetPacketId(packets::out::SteerVehiclePacket) override { return 0x1D; }
  // DisplayedRecipe = 0x1E
  // RecipeBookState = 0x1F
  // NameItem = 0x20
  virtual s32 GetPacketId(packets::out::ResourcePackStatusPacket) override { return 0x21; }
  virtual s32 GetPacketId(packets::out::AdvancementTabPacket) override { return 0x22; }
  // SelectTrade = 0x23
  // SetBeaconEffect = 0x24
  virtual s32 GetPacketId(packets::out::HeldItemChangePacket) override { return 0x25; }
  // UpdateCommandBlock = 0x26
  // UpdateCommandBlockMinecart = 0x27
  virtual s32 GetPacketId(packets::out::CreativeInventoryActionPacket) override { return 0x28; }
  // UpdateJigsawBlock = 0x29
  // UpdateStructure = 0x2A
  virtual s32 GetPacketId(packets::out::UpdateSignPacket) override { return 0x2B; }
  virtual s32 GetPacketId(packets::out::AnimationPacket) override { return 0x2C; }
  virtual s32 GetPacketId(packets::out::SpectatePacket) override { return 0x2D; }
  virtual s32 GetPacketId(packets::out::PlayerBlockPlacementPacket) override { return 0x2E; }
  virtual s32 GetPacketId(packets::out::UseItemPacket) override { return 0x2F; }

  virtual s32 GetPacketId(packets::out::PrepareCraftingGridPacket) override { throw UnsupportedPacketException("PrepareCraftingGridPacket does not work with protocol 1.16"); }
};
...
std::unordered_map<State, std::unordered_map<s32, PacketCreator>> agnosticStateMap = {
    {
        State::Login,
        {
            { protocol::login::Disconnect, []() -> packets::InboundPacket* { return new packets::in::DisconnectPacket(); } },
            { protocol::login::EncryptionRequest, []() -> packets::InboundPacket* { return new packets::in::EncryptionRequestPacket(); } },
            { protocol::login::LoginSuccess, []() -> packets::InboundPacket* { return new packets::in::LoginSuccessPacket(); } },
            { protocol::login::SetCompression, []() -> packets::InboundPacket* { return new packets::in::SetCompressionPacket(); } },
        }
    },
    {
        State::Status,
        {
            { protocol::status::Response, []() -> packets::InboundPacket* { return new packets::in::status::ResponsePacket(); } },
            { protocol::status::Pong, []() -> packets::InboundPacket* { return new packets::in::status::PongPacket(); } },
        }
    },
    {
        State::Play,
        {
            { protocol::play::SpawnObject,                  []() -> packets::InboundPacket* { return new packets::in::SpawnObjectPacket(); } },
            { protocol::play::SpawnExperienceOrb,           []() -> packets::InboundPacket* { return new packets::in::SpawnExperienceOrbPacket(); } },
            { protocol::play::SpawnGlobalEntity,            []() -> packets::InboundPacket* { return new packets::in::SpawnGlobalEntityPacket(); } },
            { protocol::play::SpawnMob,                     []() -> packets::InboundPacket* { return new packets::in::SpawnMobPacket(); } },
            { protocol::play::SpawnPainting,                []() -> packets::InboundPacket* { return new packets::in::SpawnPaintingPacket(); } },
            { protocol::play::SpawnPlayer,                  []() -> packets::InboundPacket* { return new packets::in::SpawnPlayerPacket(); } },
            { protocol::play::Animation,                    []() -> packets::InboundPacket* { return new packets::in::AnimationPacket(); } },
            { protocol::play::Statistics,                   []() -> packets::InboundPacket* { return new packets::in::StatisticsPacket(); } },
            { protocol::play::BlockBreakAnimation,          []() -> packets::InboundPacket* { return new packets::in::BlockBreakAnimationPacket(); } },
            { protocol::play::UpdateBlockEntity,            []() -> packets::InboundPacket* { return new packets::in::UpdateBlockEntityPacket(); } },
            { protocol::play::BlockAction,                  []() -> packets::InboundPacket* { return new packets::in::BlockActionPacket(); } },
            { protocol::play::BlockChange,                  []() -> packets::InboundPacket* { return new packets::in::BlockChangePacket(); } },
            { protocol::play::BossBar,                      []() -> packets::InboundPacket* { return new packets::in::BossBarPacket(); } },
            { protocol::play::ServerDifficulty,             []() -> packets::InboundPacket* { return new packets::in::ServerDifficultyPacket(); } },
            { protocol::play::TabComplete,                  []() -> packets::InboundPacket* { return new packets::in::TabCompletePacket(); } },
            { protocol::play::Chat,                         []() -> packets::InboundPacket* { return new packets::in::ChatPacket(); } },
            { protocol::play::MultiBlockChange,             []() -> packets::InboundPacket* { return new packets::in::MultiBlockChangePacket(); } },
            { protocol::play::ConfirmTransaction,           []() -> packets::InboundPacket* { return new packets::in::ConfirmTransactionPacket(); } },
            { protocol::play::CloseWindow,                  []() -> packets::InboundPacket* { return new packets::in::CloseWindowPacket(); } },
            { protocol::play::OpenWindow,                   []() -> packets::InboundPacket* { return new packets::in::OpenWindowPacket(); } },
            { protocol::play::WindowItems,                  []() -> packets::InboundPacket* { return new packets::in::WindowItemsPacket(); } },
            { protocol::play::WindowProperty,               []() -> packets::InboundPacket* { return new packets::in::WindowPropertyPacket(); } },
            { protocol::play::SetSlot,                      []() -> packets::InboundPacket* { return new packets::in::SetSlotPacket(); } },
            { protocol::play::SetCooldown,                  []() -> packets::InboundPacket* { return new packets::in::SetCooldownPacket(); } },
            { protocol::play::PluginMessage,                []() -> packets::InboundPacket* { return new packets::in::PluginMessagePacket(); } },
            { protocol::play::NamedSoundEffect,             []() -> packets::InboundPacket* { return new packets::in::NamedSoundEffectPacket(); } },
            { protocol::play::Disconnect,                   []() -> packets::InboundPacket* { return new packets::in::DisconnectPacket(); } },
            { protocol::play::EntityStatus,                 []() -> packets::InboundPacket* { return new packets::in::EntityStatusPacket(); } },
            { protocol::play::Explosion,                    []() -> packets::InboundPacket* { return new packets::in::ExplosionPacket(); } },
            { protocol::play::UnloadChunk,                  []() -> packets::InboundPacket* { return new packets::in::UnloadChunkPacket(); } },
            { protocol::play::ChangeGameState,              []() -> packets::InboundPacket* { return new packets::in::ChangeGameStatePacket(); } },
            { protocol::play::KeepAlive,                    []() -> packets::InboundPacket* { return new packets::in::KeepAlivePacket(); } },
            { protocol::play::ChunkData,                    []() -> packets::InboundPacket* { return new packets::in::ChunkDataPacket(); } },
            { protocol::play::Effect,                       []() -> packets::InboundPacket* { return new packets::in::EffectPacket(); } },
            { protocol::play::Particle,                     []() -> packets::InboundPacket* { return new packets::in::ParticlePacket(); } },
            { protocol::play::JoinGame,                     []() -> packets::InboundPacket* { return new packets::in::JoinGamePacket(); } },
            { protocol::play::Map,                          []() -> packets::InboundPacket* { return new packets::in::MapPacket(); } },
            { protocol::play::TradeList, 					[]() -> packets::InboundPacket* { return new packets::in::TradeListPacket(); } },
			{ protocol::play::EntityRelativeMove,           []() -> packets::InboundPacket* { return new packets::in::EntityRelativeMovePacket(); } },
            { protocol::play::EntityLookAndRelativeMove,    []() -> packets::InboundPacket* { return new packets::in::EntityLookAndRelativeMovePacket(); } },
            { protocol::play::EntityLook,                   []() -> packets::InboundPacket* { return new packets::in::EntityLookPacket(); } },
            { protocol::play::Entity,                       []() -> packets::InboundPacket* { return new packets::in::EntityPacket(); } },
            { protocol::play::VehicleMove,                  []() -> packets::InboundPacket* { return new packets::in::VehicleMovePacket(); } },
            { protocol::play::OpenSignEditor,               []() -> packets::InboundPacket* { return new packets::in::OpenSignEditorPacket(); } },
            { protocol::play::PlayerAbilities,              []() -> packets::InboundPacket* { return new packets::in::PlayerAbilitiesPacket(); } },
            { protocol::play::CombatEvent,                  []() -> packets::InboundPacket* { return new packets::in::CombatEventPacket(); } },
            { protocol::play::PlayerListItem,               []() -> packets::InboundPacket* { return new packets::in::PlayerListItemPacket(); } },
            { protocol::play::FacePlayer, 					[]() -> packets::InboundPacket* { return new packets::in::FacePlayerPacket();}},
			{ protocol::play::PlayerPositionAndLook,        []() -> packets::InboundPacket* { return new packets::in::PlayerPositionAndLookPacket(); } },
            { protocol::play::UseBed,                       []() -> packets::InboundPacket* { return new packets::in::UseBedPacket(); } },
            { protocol::play::DestroyEntities,              []() -> packets::InboundPacket* { return new packets::in::DestroyEntitiesPacket(); } },
            { protocol::play::RemoveEntityEffect,           []() -> packets::InboundPacket* { return new packets::in::RemoveEntityEffectPacket(); } },
            { protocol::play::ResourcePackSend,             []() -> packets::InboundPacket* { return new packets::in::ResourcePackSendPacket(); } },
            { protocol::play::Respawn,                      []() -> packets::InboundPacket* { return new packets::in::RespawnPacket(); } },
            { protocol::play::EntityHeadLook,               []() -> packets::InboundPacket* { return new packets::in::EntityHeadLookPacket(); } },
            { protocol::play::WorldBorder,                  []() -> packets::InboundPacket* { return new packets::in::WorldBorderPacket(); } },
            { protocol::play::Camera,                       []() -> packets::InboundPacket* { return new packets::in::CameraPacket(); } },
            { protocol::play::HeldItemChange,               []() -> packets::InboundPacket* { return new packets::in::HeldItemChangePacket(); } },
            { protocol::play::DisplayScoreboard,            []() -> packets::InboundPacket* { return new packets::in::DisplayScoreboardPacket(); } },
            { protocol::play::EntityMetadata,               []() -> packets::InboundPacket* { return new packets::in::EntityMetadataPacket(); } },
            { protocol::play::AttachEntity,                 []() -> packets::InboundPacket* { return new packets::in::AttachEntityPacket(); } },
            { protocol::play::EntityVelocity,               []() -> packets::InboundPacket* { return new packets::in::EntityVelocityPacket(); } },
            { protocol::play::EntityEquipment,              []() -> packets::InboundPacket* { return new packets::in::EntityEquipmentPacket(); } },
            { protocol::play::SetExperience,                []() -> packets::InboundPacket* { return new packets::in::SetExperiencePacket(); } },
            { protocol::play::UpdateHealth,                 []() -> packets::InboundPacket* { return new packets::in::UpdateHealthPacket(); } },
            { protocol::play::ScoreboardObjective,          []() -> packets::InboundPacket* { return new packets::in::ScoreboardObjectivePacket(); } },
            { protocol::play::SetPassengers,                []() -> packets::InboundPacket* { return new packets::in::SetPassengersPacket(); } },
            { protocol::play::Teams,                        []() -> packets::InboundPacket* { return new packets::in::TeamsPacket(); } },
            { protocol::play::UpdateScore,                  []() -> packets::InboundPacket* { return new packets::in::UpdateScorePacket(); } },
            { protocol::play::SpawnPosition,                []() -> packets::InboundPacket* { return new packets::in::SpawnPositionPacket(); } },
            { protocol::play::TimeUpdate,                   []() -> packets::InboundPacket* { return new packets::in::TimeUpdatePacket(); } },
            { protocol::play::Title,                        []() -> packets::InboundPacket* { return new packets::in::TitlePacket(); } },
            { protocol::play::SoundEffect,                  []() -> packets::InboundPacket* { return new packets::in::SoundEffectPacket(); } },
            { protocol::play::PlayerListHeaderAndFooter,    []() -> packets::InboundPacket* { return new packets::in::PlayerListHeaderAndFooterPacket(); } },
            { protocol::play::CollectItem,                  []() -> packets::InboundPacket* { return new packets::in::CollectItemPacket(); } },
            { protocol::play::EntityTeleport,               []() -> packets::InboundPacket* { return new packets::in::EntityTeleportPacket(); } },
            { protocol::play::EntityProperties,             []() -> packets::InboundPacket* { return new packets::in::EntityPropertiesPacket(); } },
            { protocol::play::EntityEffect,                 []() -> packets::InboundPacket* { return new packets::in::EntityEffectPacket(); } },
            { protocol::play::AdvancementProgress,          []() -> packets::InboundPacket* { return new packets::in::AdvancementProgressPacket(); } },
            { protocol::play::Advancements,                 []() -> packets::InboundPacket* { return new packets::in::AdvancementsPacket(); } },
            { protocol::play::UnlockRecipes,                []() -> packets::InboundPacket* { return new packets::in::UnlockRecipesPacket(); } },
        }
    }
};
...
Protocol::StateMap inboundMap_1_14_2 = {
    ...
    },
    {
        State::Play,
        {
            ...
            { 0x33, protocol::play::PlayerListItem },
            ...
            // { 0x50, protcol::EntitySoundEffect },
...
Protocol::StateMap inboundMap_1_16_5 = {
    {
        State::Login,
        {
            { 0x00, protocol::login::Disconnect },
    ...
    },
    {
        State::Play,
        {
            { 0x00, protocol::play::SpawnObject },
            { 0x01, protocol::play::SpawnExperienceOrb },
            { 0x02, protocol::play::SpawnMob },
            { 0x03, protocol::play::SpawnPainting },
            { 0x04, protocol::play::SpawnPlayer },
            { 0x05, protocol::play::Animation },
            { 0x06, protocol::play::Statistics },
			//{ 0x07, protocol::play::Acknowledge},
            { 0x08, protocol::play::BlockBreakAnimation },
            { 0x09, protocol::play::UpdateBlockEntity },
            { 0x0A, protocol::play::BlockAction },
            { 0x0B, protocol::play::BlockChange },
            ...
            { 0x0D, protocol::play::ServerDifficulty },
            { 0x0E, protocol::play::Chat },
            { 0x0F, protocol::play::TabComplete },
           // { 0x10, protocol::play::DeclareCommands },
            { 0x11, protocol::play::ConfirmTransaction },
            { 0x12, protocol::play::CloseWindow },
            { 0x13, protocol::play::WindowItems },
            { 0x14, protocol::play::WindowProperty },
            { 0x15, protocol::play::SetSlot },
            { 0x16, protocol::play::SetCooldown },
            { 0x17, protocol::play::PluginMessage },
            { 0x18, protocol::play::NamedSoundEffect },
            { 0x19, protocol::play::Disconnect },
            { 0x1A, protocol::play::EntityStatus },
            { 0x1B, protocol::play::Explosion },
            { 0x1C, protocol::play::UnloadChunk },
            { 0x1D, protocol::play::ChangeGameState },
            //{ 0x1E, protocol::play::OpenHorseWindow },
            { 0x1F, protocol::play::KeepAlive },
            { 0x20, protocol::play::ChunkData },
            { 0x21, protocol::play::Effect },
            { 0x22, protocol::play::Particle },
            //{ 0x23, protocol::play::UpdateLight },
            { 0x24, protocol::play::JoinGame },
            { 0x25, protocol::play::Map },
            { 0x26, protocol::play::TradeList },
            { 0x27, protocol::play::EntityRelativeMove },
            { 0x28, protocol::play::EntityLookAndRelativeMove },
            { 0x29, protocol::play::EntityLook },
            { 0x2A, protocol::play::Entity },
            { 0x2B, protocol::play::VehicleMove },
            //{ 0x2C, protocol::play::OpenBook },
            { 0x2D, protocol::play::OpenWindow },
            { 0x2E, protocol::play::OpenSignEditor },
            { 0x2F, protocol::play::CraftRecipeResponse },
            { 0x30, protocol::play::PlayerAbilities },
            { 0x31, protocol::play::CombatEvent },
            { 0x32, protocol::play::PlayerListItem },
            { 0x33, protocol::play::FacePlayer },
            { 0x34, protocol::play::PlayerPositionAndLook },
            { 0x35, protocol::play::UnlockRecipes },
            { 0x36, protocol::play::DestroyEntities },
            { 0x37, protocol::play::RemoveEntityEffect },
            { 0x38, protocol::play::ResourcePackSend },
            { 0x39, protocol::play::Respawn },
            { 0x3A, protocol::play::EntityHeadLook },
			{ 0x3B, protocol::play::MultiBlockChange},
            //{ 0x3C, protocol::play::SelectAdvancementTab },
            { 0x3D, protocol::play::WorldBorder },
            { 0x3E, protocol::play::Camera },
            { 0x3F, protocol::play::HeldItemChange },
            ...
            { 0x4C, protocol::play::Teams },
            { 0x4D, protocol::play::UpdateScore },
            { 0x42, protocol::play::SpawnPosition },
            { 0x4E, protocol::play::TimeUpdate },
			//{ 0x4F, protocol::play::Title },
...
const std::unordered_map<Version, std::shared_ptr<Protocol>> protocolMap = {
    ...
    { Version::Minecraft_1_14_2, std::make_shared<Protocol_1_14_2>(Version::Minecraft_1_14_2, inboundMap_1_14_2) },
    { Version::Minecraft_1_15_2, std::make_shared<Protocol_1_15_2>(Version::Minecraft_1_15_2, inboundMap_1_15_2) },
	{ Version::Minecraft_1_16_4, std::make_shared<Protocol_1_16_5>(Version::Minecraft_1_16_4, inboundMap_1_16_5) },
	{ Version::Minecraft_1_16_5, std::make_shared<Protocol_1_16_5>(Version::Minecraft_1_16_5, inboundMap_1_16_5) },
};
...
packets::InboundPacket* Protocol::CreateInboundPacket(State state, s32 protocolId) {
    s32 agnosticId = 0;

    if (!GetAgnosticId(state, protocolId, agnosticId))
        return nullptr;
...
std::string to_string(Version version) {
    static const std::unordered_map<mc::protocol::Version, std::string> mapping = {
		...
		{ mc::protocol::Version::Minecraft_1_16_4, "1.16.4" },
		{ mc::protocol::Version::Minecraft_1_16_5, "1.16.5" },
    };
